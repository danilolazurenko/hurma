...
def get_job_args():
    try:
<<<<<<< HEAD
        spark_root, input_file_parent, input_file_children, output_file, output_format, session_name = sys.argv[1:]
=======
        spark_root, parent_org_input, org_input, output_file, output_format, session_name = sys.argv[1:]
>>>>>>> 367a7c7d81242086d1e682f2064ad7e1fe0decb3
    except IndexError:
        print("""
            Positional parameters of job 
            spark_root     '/home/ubuntu/bin/spark-3.0.3-bin-hadoop2.7'
<<<<<<< HEAD
            input_file_parent   '/home/ubuntu/Documents/parent_organizations'
            input_file_children   '/home/ubuntu/Documents/organizations'
=======
...
<<<<<<< HEAD
    return spark_root, input_file_parent, input_file_children, output_file, output_format, session_name
=======
...
<<<<<<< HEAD
    spark_root, input_file_parent, input_file_children, output_file, output_format, session_name = get_job_args()

    spark = build_spark_session(spark_root, session_name)
    dataframe_1 = spark.read.parquet(input_file_parent)
    dataframe_2 = spark.read.parquet(input_file_children)
    output_data_frame = (dataframe_1
        .select(['parent_uuid', 'uuids', 'names', 'children_count'])
